 ...
 * Use the [SellerOngoingOffersFragment.newInstance] factory method to
...
class SellerOngoingOffersFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SellerOngoingOffersFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SellerOngoingOffersFragment().apply {
